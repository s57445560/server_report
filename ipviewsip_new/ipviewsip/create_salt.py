    ...
    for i in pk[1:]:
        for k, v in i.items():
            ...
            if config_obj:
                ...
                default1 = {"memorytotal": host_l[1], "memoryuse": host_l[2], "memoryrate": r.findall(host_l[3])[0],
                ...
                default2 = {"memorytotal": host_l[1], "memoryuse": host_l[2], "memoryrate": r.findall(host_l[3])[0],
                           "cpucore": host_l[4], "averageload": 0 if host_l[5]=="" else host_l[5], "disktotal": host_l[6], "diskuse": host_l[7],
