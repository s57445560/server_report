...
# IP地址|总能存|内存使用率|cpu核心数|cpuload值|磁盘总容量|磁盘使用容量|磁盘使用率
echo "$ip|$mem|$mem_use|$mem_b|$cpu_number|$cpu_load|$disk_all_number|$disk_use|$disk_b|$type"
